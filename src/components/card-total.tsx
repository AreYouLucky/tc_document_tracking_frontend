...
export default function CardTotal({ total, subtitle }: CardTotalProps) {
  return (
    <div className="flex flex-col items-center justify-center gap-2 bg-white rounded-4xl p-6 shadow-lg border-2 border-orange-400 transition-transform duration-200 hover:scale-[1.02]">
