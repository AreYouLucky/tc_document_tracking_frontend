...
export default function DocumentBooking() {
    ...
    const createBookingFn = () => {
        ...
        formData.append("office", item.requesting_office!);
    ...
    return (
        <BookingLayout>
            <section className=" px-6 py-6 md:px-8 md:py-2 space-y-7">
            ...
            <SuccessDialog show={showSuccessDialog} onClose={closeSuccessDialog} />
